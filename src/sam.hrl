...
-define(LSP_DIAGNOSTIC_SEVERITY_ERROR, 1).
-define(LSP_DIAGNOSTIC_SEVERITY_WARNING, 2).
-define(LSP_DIAGNOSTIC_SEVERITY_INFORMATION, 3).
-define(LSP_DIAGNOSTIC_SEVERITY_HINT, 4).
