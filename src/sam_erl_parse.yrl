...
record_tuple -> '{' '}' : [{record_close, ?anno('$2')}].
record_tuple -> '{' record_fields '}' : '$2' ++ [{record_close, ?anno('$3')}].
...
function_call -> expr_remote argument_list :
	% davisp - Tweaked to capture position of the last paren
	{call,?anno('$2'),'$1',element(1, '$2')}.
...
fun_expr -> 'fun' atom '/' integer :
	{'fun',?anno_ex('$1', [{'end', '$4'}]),{function,element(3, '$2'),element(3, '$4')}}.
fun_expr -> 'fun' atom_or_var ':' atom_or_var '/' integer_or_var :
	{'fun',?anno_ex('$1', [{'end', '$6'}]),{function,'$2','$4','$6'}}.
